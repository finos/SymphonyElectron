...
export class WindowHandler {
    ...
    public async createApplication() {
        ...
        logger.info('window-handler: isWindowsOS: ' + isWindowsOS);
        ...
        if (isWindowsOS) {
            ...
            logger.info('window-handler: getBounds: ' + JSON.stringify(getBounds(this.config.mainWinPos, DEFAULT_WIDTH, DEFAULT_HEIGHT) as Electron.Rectangle));
        }
